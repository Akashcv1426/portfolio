...
const typed = new Typed(".multiple-text", {
  strings: ["MCA Graduate", "Software Developer"],
  typeSped: 100,
  backSpeed: 100,
  backDelay: 1000,
  loop: true,
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    emailjs.sendForm("service_84ms6lc", "template_q78jnwd", this).then(
      function () {
...
function openProjectModal(btn) {
  ...
  document.getElementById("modalGithub").href = btn.dataset.github;
